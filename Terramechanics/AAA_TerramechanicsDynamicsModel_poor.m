...
Kw = 0;%0.022;    % 0.022 standard     %0.055 results in zero drawbar pull at zero slip given above conditions
Kr = 0;%0.66;        % 0.66 standard

% Snow from Wong p.136 (Harrison)
phi_d = 9;
phi = phi_d*pi/180;    % angle of internal shearing resistance
c = 0.45;            % cohesion of soil  kPa 
Ks =0.05;           % shear deformation modulus (m)

kc = 0;%2.49;          % kPa/m^n-1 
kphi = 0;%245.9;       % pressure sinkage parameters  kPa/m*n
n = 0;%1.6;
...
if slipCalc == 1
    ...
    title('Poorly Bonded', 'FontSize', 16)
